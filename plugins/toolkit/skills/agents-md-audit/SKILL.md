...
Audit, evaluate, and improve AGENTS.md files across a codebase to ensure DeepSeek Harness has optimal project context.
...
| Global defaults | `~/.dsh/AGENTS.md` | User-wide defaults across all projects |
| Package-specific | `./packages/*/AGENTS.md` | Module-level context in monorepos |
| Subdirectory | Any nested location | Feature/domain-specific context |

**Note:** The agent auto-discovers AGENTS.md files in parent directories, making monorepo setups work automatically.
...
- **Recording learnings**: ask the agent during a session to fold what it just learned into `AGENTS.md`
...
- **Global defaults**: Put user-wide preferences in `~/.dsh/AGENTS.md`
