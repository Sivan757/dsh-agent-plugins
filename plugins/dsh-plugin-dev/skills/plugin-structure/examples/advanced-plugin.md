  ...
  "PreToolUse": [
    ...
    },
    {
      ...
      "hooks": [
        {
          "type": "command",
          "command": "bash ${PLUGIN_ROOT}/hooks/scripts/security/check-bash-safety.sh",
          "timeout": 20
        }
      ]
    }
