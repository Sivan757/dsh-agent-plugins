...
# Plugin Settings Pattern for DeepSeek Harness Plugins
...
2. Read the configuration with the read tool
...
5. Remind user to restart DeepSeek Harness for hooks to recognize changes
```
...
After creating or editing, restart DeepSeek Harness for changes to take effect.
```
...
**Important:** Settings changes require DeepSeek Harness restart.
...
7. Remind users that changes require DeepSeek Harness restart
