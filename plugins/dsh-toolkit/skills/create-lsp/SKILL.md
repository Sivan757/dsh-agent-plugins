---
name: create-lsp
description: Add a language server to DeepSeek Harness by writing a validated LSP declaration. Use when the user asks to "set up LSP", "add a language server", "enable diagnostics", or reports that go-to-definition or diagnostics do not work.
---
...
- A plugin the project installs through the market page: the plugin's own `com.deepseek.harness/lsp.json`.
