...
allowed-tools: ["Write", "ask_user_question"]
---
...
Use ask_user_question to gather configuration:
...
Extract answers from ask_user_question result:
...
To modify settings, edit this file and restart DeepSeek Harness.
```
...
- Reminder: Restart DeepSeek Harness for changes to take effect
