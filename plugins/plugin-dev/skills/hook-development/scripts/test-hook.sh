...
# Set up environment
export DSH_PROJECT_DIR="${DSH_PROJECT_DIR:-/tmp/test-project}"
export PLUGIN_ROOT="${PLUGIN_ROOT:-$(pwd)}"
export DSH_ENV_FILE="${DSH_ENV_FILE:-/tmp/test-env-$$}"

if [ "$VERBOSE" = true ]; then
  echo "Environment:"
  echo "  DSH_PROJECT_DIR=$DSH_PROJECT_DIR"
  echo "  PLUGIN_ROOT=$PLUGIN_ROOT"
  echo "  DSH_ENV_FILE=$DSH_ENV_FILE"
  echo ""
fi
