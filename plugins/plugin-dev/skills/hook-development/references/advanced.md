...
Layer command hooks for validation at different depths:
  ...
  "PreToolUse": [
    {
      ...
      "hooks": [
        ...
        {
          "type": "command",
          "command": "bash check-content.sh",   // Independent
          "timeout": 10
        }
      ]
    }
...
export DSH_PROJECT_DIR="/tmp/test-project"
export PLUGIN_ROOT="$(pwd)"
mkdir -p "$DSH_PROJECT_DIR"
