...
Read `${PLUGIN_ROOT}/workflows/uplift-deltas.meta.json` and
`${PLUGIN_ROOT}/workflows/uplift-deltas.js`, then pass the meta file's
contents as `meta` and the script file's contents (the JavaScript body, with
no `export const meta` line) as `script`:

```
workflow({
  meta: <contents of ${PLUGIN_ROOT}/workflows/uplift-deltas.meta.json>,
  script: <contents of ${PLUGIN_ROOT}/workflows/uplift-deltas.js>,
...
Read `${PLUGIN_ROOT}/workflows/uplift-migrate.meta.json` and
`${PLUGIN_ROOT}/workflows/uplift-migrate.js`, then pass the meta file's
contents as `meta` and the script file's contents (the JavaScript body, with
no `export const meta` line) as `script`:

```
workflow({
  meta: <contents of ${PLUGIN_ROOT}/workflows/uplift-migrate.meta.json>,
  script: <contents of ${PLUGIN_ROOT}/workflows/uplift-migrate.js>,
