...
The [dsh-toolkit plugin](https://github.com/Sivan757/dsh-agent-plugins/tree/main/plugins/dsh-toolkit) declares the namespace and ships three commands, three agent roles, and fourteen skills — the [dsh-agent-plugins](https://github.com/Sivan757/dsh-agent-plugins) repository doubles as the reference implementation.
